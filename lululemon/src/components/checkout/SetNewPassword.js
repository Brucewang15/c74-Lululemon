...
export const SetNewPassword = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (password === password2) {
            ...
            try {
                const response = await fetch(`http://localhost:3399/change/changepassword/${token}`, {
                    method: "POST",
                    headers: {
    ...
    return <>
        ...
        <div className="main">
            <div className="container">
                ...
                <input onChange = {handlePasswordChange} className='password' type="password"/>
            </div>
            <div className="container">
                <div className="title2">Re-enter New Password</div>
                <input onChange={handlePasswordChange2} type="password" className="password2"/>
            </div>
            <div className="container">
